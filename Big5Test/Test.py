...
class Test:
    def __init__(self, test_id, questions: QuestionsType, scoring_function: Callable[[QuestionsType], Dict[str, str]]):
...
class Big5Test(Test):
    def __init__(self, test_id):
        ...
        super().__init__(test_id=test_id, questions=self._question_dct, scoring_function=Big5Test.big_five_scoring)
