...
class GladiatorAttackInformation:
    def __init__(self):
        self.attack_types = json.load(open(os.path.join(os.path.dirname(__file__), "GladiatorAttackBuffs.json"), "r"))
        self.damage_types =  json.load(open(os.path.join(os.path.dirname(__file__), "GladiatorDamageTypes.json"), "r"))
        self.turn_debuffs = json.load(open(os.path.join(os.path.dirname(__file__), "GladiatorTurnDebuffs.json"), "r"))
